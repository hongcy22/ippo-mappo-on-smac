...
def get_common_args():
    ...
    parser.add_argument('--last_action', type=int, default=1, help='whether to use the last action to choose action')
    parser.add_argument('--reuse_network', type=int, default=1, help='whether to use one network for all agents')
    ...
    parser.add_argument('--learn', type=int, default=1, help='whether to train the model')
